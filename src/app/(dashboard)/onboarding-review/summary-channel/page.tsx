  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold text-foreground">Onboarding - Summary Channel</h1>
          <p className="text-sm text-muted mt-1">Summary overview for onboarding review.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-white rounded-xl border border-border p-5 text-center">
          <p className="text-sm text-muted">Channels Under Review</p>
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="bg-slate-50 border-b border-border">
                ...
                <th className="text-left px-4 py-3 font-semibold text-foreground">Review Status</th>
              </tr>
            </thead>
            <tbody>
              {channels.map((ch, i) => (
